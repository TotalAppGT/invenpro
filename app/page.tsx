...
const plans = [
  {
    ...
    priceYearly: 1490,
    popular: false,
    description: "Para pequeños negocios que quieren dejar el Excel y tener control profesional de su inventario.",
    features: [
      "3 usuarios",
      "2 bodegas",
      "Hasta 500 productos",
      "Control de entradas y salidas",
      "Kardex básico (Promedio)",
  ...
  },
  {
    ...
    priceYearly: 3490,
    popular: true,
    description: "Para empresas que necesitan control total de inventario con funciones avanzadas y alertas en tiempo real.",
    features: [
      "10 usuarios",
      "10 bodegas",
      "Productos ilimitados",
      "Kardex completo (PEPS / UEPS / Promedio)",
      "Conteos físicos con celular (cámara/pistola)",
      "Órdenes de compra y recepción de mercadería",
      "Alertas por WhatsApp (stock bajo, vencimientos)",
      "Generador de etiquetas y códigos de barras",
      "Notificaciones programables (día/hora)",
      "Dashboard con KPIs en tiempo real",
      "Importación masiva CSV y Excel",
      "Cierres de inventario por período",
      "API REST (lectura de datos)",
  ...
  },
  {
    ...
    priceYearly: 7990,
    popular: false,
    description: "Para empresas grandes que necesitan multi-sucursal, integraciones, personalización y control total.",
    features: [
      "Usuarios ilimitados",
      "Bodegas ilimitadas",
      "Productos ilimitados",
      "Todas las funciones del plan Negocio",
      "API REST completa (lectura y escritura)",
      "Personalización de marca (logo y colores)",
      "WhatsApp Business API (mensajes salientes)",
      "Webhooks para integraciones externas",
      "Cierres contables automatizados",
      "Auditoría avanzada de operaciones",
      "Cuadres y conciliaciones masivas",
...
const comparisonFeatures = [
  ...
  { name: "Movimientos (entradas/salidas)", emprendedor: "Sí", negocio: "Sí", corporativo: "Sí" },
  { name: "Kardex valorizado", emprendedor: "Promedio", negocio: "PEPS/UEPS/Prom", corporativo: "PEPS/UEPS/Prom" },
  { name: "Conteos físicos con celular", emprendedor: "—", negocio: "Sí", corporativo: "Sí" },
  { name: "Órdenes de compra", emprendedor: "—", negocio: "Sí", corporativo: "Sí" },
  { name: "Etiquetas y códigos de barras", emprendedor: "—", negocio: "Sí", corporativo: "Sí" },
  { name: "Notificaciones programables", emprendedor: "—", negocio: "Sí", corporativo: "Sí" },
  { name: "Alertas", emprendedor: "Email", negocio: "Email + WhatsApp", corporativo: "Email + WhatsApp" },
  { name: "Dashboard KPIs", emprendedor: "Básico", negocio: "Completo", corporativo: "Completo" },
  { name: "Cierres de inventario", emprendedor: "—", negocio: "Sí", corporativo: "Sí + Contables" },
  { name: "Importación masiva", emprendedor: "CSV", negocio: "CSV + Excel", corporativo: "CSV + Excel" },
  { name: "API REST", emprendedor: "—", negocio: "Solo lectura", corporativo: "Lectura/Escritura" },
  { name: "Personalización de marca", emprendedor: "—", negocio: "—", corporativo: "Sí" },
  { name: "Webhooks", emprendedor: "—", negocio: "—", corporativo: "Sí" },
  { name: "Auditoría avanzada", emprendedor: "—", negocio: "—", corporativo: "Sí" },
  { name: "Exportación reportes", emprendedor: "PDF, Excel", negocio: "PDF, Excel, CSV", corporativo: "PDF, Excel, CSV + Contable" },
  { name: "Soporte", emprendedor: "Email", negocio: "WhatsApp prioritario", corporativo: "WhatsApp dedicado" },
];
